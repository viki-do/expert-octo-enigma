...
const Footer = () => {
  ...
  return (
    <div className=" h-[750px] bg-custom-gradient flex flex-col lg:px-28">
      ...
      <div className="flex flex-col lg:w-3/12 lg:pt-20">
        <h2 className="px-10 text-center text-3xl2 font-medium text-white pb-10 lg:text-left lg:px-0">
        ...
        <div className="flex justify-center lg:justify-start flex-col items-center lg:items-start">
          ...
          <p className="text-[#8B8294] text-lg2 lg:text-sm">The latest in AI, language, and RLHF</p>
        </div>
        <div className="flex justify-between px-5 mt-7 h-24 lg:px-0 lg:mt-3 lg:h-[76px]">
          <div className="flex flex-col ">
            <p
              className={`pb-3 ${
                isFocused ? 'text-white text-lg pt-0' : 'text-[#8B8294] text-lg2 pt-10'
            ...
            <input
              ...
              className={`bg-transparent border-none outline-none caret-white placeholder-[#8B8294] ${
                email || isFocused ? 'text-lg placeholder:text-lg' : 'text-base placeholder:text-base'
              } text-white`}
          ...
          <div className="flex flex-col pt-10">
            <p
              className={`${
                isFocused ? 'text-white' : 'text-[#8B8294]'
              } text-lg2 lg:text-sm`}
            >
              Subscribe
            </p>
